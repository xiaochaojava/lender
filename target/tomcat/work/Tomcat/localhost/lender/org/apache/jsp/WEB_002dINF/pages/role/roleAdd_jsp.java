 ...
 * Generated at: 2017-01-10 10:28:03 UTC
...
public final class roleAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form id=\"roleAddForm\" class=\"itemForm\" method=\"post\">\r\n");
      out.write("\t    <table cellpadding=\"5\">\r\n");
      out.write("\t        <tr>\r\n");
      out.write("\t            <td>角色名称:</td>\r\n");
      out.write("\t            <td><input class=\"easyui-validatebox\" type=\"text\" name=\"roleName\" data-options=\"required:true\" missingMessage=\"角色名称必须填写\"  style=\"width: 280px;\"></input></td>\r\n");
      out.write("\t        </tr>\r\n");
      out.write("     \r\n");
      out.write("\t        <tr>\r\n");
      out.write("\t            <td>备注:</td>\r\n");
      out.write("\t            <td>\r\n");
      out.write("\t                <textarea style=\"width:800px;height:300px;visibility:hidden;\" name=\"remark\"></textarea>\r\n");
      out.write("\t            </td>\r\n");
      out.write("\t        </tr>\r\n");
      out.write("\t    </table>\r\n");
      out.write("\t   \r\n");
      ...
      out.write("\tvar roleAddEditor ;\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t//和form下的desc组件绑定\r\n");
      out.write("\t\troleAddEditor = KindEditorUtil.createEditor(\"#roleAddForm [name=remark]\");\r\n");
      out.write("\t\tKindEditorUtil.init({fun:function(node){\r\n");
      out.write("\t\t\tKindEditorUtil.changeItemParam(node, \"roleAddForm\");\r\n");
      out.write("\t\t}});\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\tfunction submitForm(){\r\n");
      out.write("\t\t//表单校验\r\n");
      out.write("\t\tif(!$('#roleAddForm').form('validate')){\r\n");
      out.write("\t\t\t$.messager.alert('提示','表单还未填写完成!');\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\troleAddEditor.sync();//将输入的内容同步到多行文本中\r\n");
      out.write("\t\tvar paramJson = [];\r\n");
      out.write("\t\t$(\"#roleAddForm .params li\").each(function(i,e){\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#roleAddForm [name=RoleParams]\").val(paramJson);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/save.html\",$(\"#roleAddForm\").serialize(), function(data){\r\n");

...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="../../pub/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="../../pub/css/passport.base.css"/>
    <script type="text/javascript" src="../../pub/js/jquery-1.2.6.min.js"></script>
</head>
<body>
